...
async function generateCvPdf() {
  ...
  setTextColor(doc, colors.link);
  doc.setFont("helvetica", "normal");
  drawLinkedText(doc, cvData.email, `mailto:${cvData.email}`, page.margin + 51, y + 39);
  y += 54;
